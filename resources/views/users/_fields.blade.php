...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="first_name" id="first_ame" placeholder="Pedro" value="{{ old('first_name', $user->first_name) }}">
</div>

<div class="form-group">
    <label for="name">Apellido:</label>
    <input type="text" class="form-control" name="last_name" id="last_ame" placeholder="Perez" value="{{ old('last_name', $user->last_name) }}">
</div>
