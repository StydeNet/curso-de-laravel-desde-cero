    ...
    @if ($users->isNotEmpty())
        ...
        <div class="table-responsive-lg">
            <table class="table table-sm">
                ...
                <tr>
                    <th scope="col">#</th>
                    <th scope="col"><a wire:click="changeOrder('name')" href="{{ $sortable->url('name') }}" class="{{ $sortable->classes('name') }}">Nombre <i class="icon-sort"></i></a></th>
                    <th scope="col"><a wire:click="changeOrder('email')" href="{{ $sortable->url('email') }}" class="{{ $sortable->classes('email') }}">Correo <i class="icon-sort"></i></a></th>
